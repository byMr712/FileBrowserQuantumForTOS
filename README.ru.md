...
- **Обновлён до 2.0.0-beta:** [Mr712](https://github.com/byMr712?tab=repositories).
...
| `README.md` | README на английском (по умолчанию) |
| `README.ru.md` | README на русском (на GitHub автоматически показывается пользователям с русским языком интерфейса) |
...
- `bin/filebrowser.yml` — рабочий конфиг v2 (формат FileBrowser Quantum 2.0):
  ...
  При первом запуске копируется в папку конфига NAS. Логин по умолчанию `admin/admin`.
