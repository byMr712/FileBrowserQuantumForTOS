...
| Path | Description |
|---|---|
| `FileBrowserQuantum_TOS7_TOS6_2.0.5.0-beta-x86_64.tpk` | Ready package for App Center |
...
`FileBrowserQuantum_TOS7_TOS6_2.0.5.0-beta-x86_64.tpk` (id, version and platform come from `config.ini`).
